        ...
        function validateField(input) {
            ...
            if (input.pattern && input.value.trim()) {
                ...
                if (!regex.test(input.value.trim())) {
                    const title = input.title || 'Invalid format';
            ...
            if (isValid) {
                ...
                fetch(formAction, fetchOptions)
                    ...
                    .catch(function() {
                        ...
                        errorMessage.textContent = contactForm.dataset.errorMessage || 'Oops! Something went wrong. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2edc8df4-a664-4802-b85d-892f42bab61e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2edc8df4-a664-4802-b85d-892f42bab61e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2edc8df4-a664-4802-b85d-892f42bab61e';
